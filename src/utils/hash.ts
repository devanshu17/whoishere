 ...
 */
export async function comparePasswords(password: string, hashedPassword: string | undefined): Promise<boolean> {
  if(!hashedPassword) throw new Error('Password must not be empty');
